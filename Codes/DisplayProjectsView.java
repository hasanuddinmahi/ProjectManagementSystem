...
// View for displaying projects - by Yeak Yi Han
public class DisplayProjectsView extends JFrame {
    ...
    public DisplayProjectsView() throws IOException {
        GUI();
    }
    ...
    protected void GUI() throws IOException {
        ...
        for (int i = 0; i < project_list.size(); i++) {
            ...
            String status = project_list.get(i).getProjectStatus();
